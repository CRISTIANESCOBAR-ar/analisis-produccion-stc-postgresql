...
\restrict fWfKO3w8I26iGRh6KBjZYW6z6vasyMnHgbKPeW6aPJP0dUbmr8f5lYOLdaTWC9Z
...
COMMENT ON TABLE public.tb_calidad_fibra IS 'Calidad y movimientos de materia prima (fibra/algod├│n)';
...
--
-- Name: tb_costo_item_alias; Type: TABLE; Schema: public; Owner: stc_user
--

CREATE TABLE public.tb_costo_item_alias (
    id integer NOT NULL,
...
ALTER TABLE public.tb_costo_item_alias OWNER TO stc_user;

--
-- Name: tb_costo_item_alias_id_seq; Type: SEQUENCE; Schema: public; Owner: stc_user
--

CREATE SEQUENCE public.tb_costo_item_alias_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tb_costo_item_alias_id_seq OWNER TO stc_user;

--
-- Name: tb_costo_item_alias_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: stc_user
--

ALTER SEQUENCE public.tb_costo_item_alias_id_seq OWNED BY public.tb_costo_item_alias.id;


--
-- Name: tb_costo_items; Type: TABLE; Schema: public; Owner: stc_user
--

CREATE TABLE public.tb_costo_items (
    id integer NOT NULL,
...
ALTER TABLE public.tb_costo_items OWNER TO stc_user;

--
-- Name: tb_costo_items_id_seq; Type: SEQUENCE; Schema: public; Owner: stc_user
--

CREATE SEQUENCE public.tb_costo_items_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tb_costo_items_id_seq OWNER TO stc_user;

--
-- Name: tb_costo_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: stc_user
--

ALTER SEQUENCE public.tb_costo_items_id_seq OWNED BY public.tb_costo_items.id;


--
-- Name: tb_costo_mensual; Type: TABLE; Schema: public; Owner: stc_user
--

CREATE TABLE public.tb_costo_mensual (
    id integer NOT NULL,
...
ALTER TABLE public.tb_costo_mensual OWNER TO stc_user;

--
-- Name: tb_costo_mensual_id_seq; Type: SEQUENCE; Schema: public; Owner: stc_user
--

CREATE SEQUENCE public.tb_costo_mensual_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tb_costo_mensual_id_seq OWNER TO stc_user;

--
-- Name: tb_costo_mensual_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: stc_user
--

ALTER SEQUENCE public.tb_costo_mensual_id_seq OWNED BY public.tb_costo_mensual.id;
...
--
-- Name: tb_narrativa_cache; Type: TABLE; Schema: public; Owner: stc_user
--

CREATE TABLE public.tb_narrativa_cache (
    ...
    origen character varying(100) DEFAULT 'Desconocido'::character varying
);


ALTER TABLE public.tb_narrativa_cache OWNER TO stc_user;

--
-- Name: tb_narrativa_log; Type: TABLE; Schema: public; Owner: stc_user
--

CREATE TABLE public.tb_narrativa_log (
    id integer NOT NULL,
    lotes text NOT NULL,
    fecha_corte character varying(50),
    formato character varying(32),
    ...
    fuente character varying(16) DEFAULT 'gemini'::character varying,
...
ALTER TABLE public.tb_narrativa_log OWNER TO stc_user;

--
-- Name: tb_narrativa_log_id_seq; Type: SEQUENCE; Schema: public; Owner: stc_user
--

CREATE SEQUENCE public.tb_narrativa_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.tb_narrativa_log_id_seq OWNER TO stc_user;

--
-- Name: tb_narrativa_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: stc_user
--

ALTER SEQUENCE public.tb_narrativa_log_id_seq OWNED BY public.tb_narrativa_log.id;
...
COMMENT ON TABLE public.tb_paradas IS 'Tabla de paradas de m├íquinas - replicada desde SQLite';
...
COMMENT ON TABLE public.tb_parametros_hvi IS 'Par├ímetros de calidad para variables HVI con rangos ├│ptimos, aceptables y cr├¡ticos';
...
COMMENT ON COLUMN public.tb_parametros_hvi.codigo IS 'C├│digo ├║nico de la variable HVI';
...
COMMENT ON COLUMN public.tb_parametros_hvi.descripcion IS 'Descripci├│n t├®cnica detallada extra├¡da de tooltips HVI';
...
COMMENT ON COLUMN public.tb_parametros_hvi.optimo_min IS 'L├¡mite inferior del rango ├│ptimo';
...
COMMENT ON COLUMN public.tb_parametros_hvi.optimo_max IS 'L├¡mite superior del rango ├│ptimo';
...
COMMENT ON COLUMN public.tb_parametros_hvi.aceptable_min IS 'L├¡mite inferior del rango aceptable';
...
COMMENT ON COLUMN public.tb_parametros_hvi.aceptable_max IS 'L├¡mite superior del rango aceptable';
...
COMMENT ON COLUMN public.tb_parametros_hvi.critico_min IS 'L├¡mite inferior del rango cr├¡tico';
...
COMMENT ON COLUMN public.tb_parametros_hvi.critico_max IS 'L├¡mite superior del rango cr├¡tico';
...
COMMENT ON COLUMN public.tb_parametros_hvi.grupo IS 'Categor├¡a t├®cnica de agrupaci├│n de la variable HVI';
...
COMMENT ON TABLE public.tb_proceso IS 'Posici├│n de stock en proceso (producci├│n en curso)';
...
COMMENT ON TABLE public.tb_produccion_carda IS 'Tabla de producci├│n de cardas (turno/maquina) importada desde rptProducaoCarda.csv';
...
COMMENT ON TABLE public.tb_produccion_oe IS 'Tabla de producci├│n OE (Open End) - replicada desde SQLite';
...
COMMENT ON TABLE public.tb_residuos_indigo IS 'Residuos de ├¡ndigo por sector y turno';
...
COMMENT ON COLUMN public.tb_sync_history.operation_type IS 'Tipo: COLUMN_SYNC (agregar columnas), IMPORT (importaci├│n), FORCE_IMPORT (reimportaci├│n forzada)';
...
COMMENT ON COLUMN public.tb_sync_history.columns_added IS 'Array de nombres de columnas que fueron agregadas en la sincronizaci├│n';
...
COMMENT ON TABLE public.tb_testes IS 'Tabla de testes f├¡sicos - replicada desde SQLite';
...
--
-- Name: tb_costo_item_alias id; Type: DEFAULT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_item_alias ALTER COLUMN id SET DEFAULT nextval('public.tb_costo_item_alias_id_seq'::regclass);


--
-- Name: tb_costo_items id; Type: DEFAULT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_items ALTER COLUMN id SET DEFAULT nextval('public.tb_costo_items_id_seq'::regclass);


--
-- Name: tb_costo_mensual id; Type: DEFAULT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_mensual ALTER COLUMN id SET DEFAULT nextval('public.tb_costo_mensual_id_seq'::regclass);
...
--
-- Name: tb_narrativa_log id; Type: DEFAULT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_narrativa_log ALTER COLUMN id SET DEFAULT nextval('public.tb_narrativa_log_id_seq'::regclass);
...
--
-- Name: tb_costo_item_alias tb_costo_item_alias_origen_nombre_en_origen_key; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_item_alias
    ADD CONSTRAINT tb_costo_item_alias_origen_nombre_en_origen_key UNIQUE (origen, nombre_en_origen);


--
-- Name: tb_costo_item_alias tb_costo_item_alias_pkey; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_item_alias
    ADD CONSTRAINT tb_costo_item_alias_pkey PRIMARY KEY (id);


--
-- Name: tb_costo_items tb_costo_items_codigo_key; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_items
    ADD CONSTRAINT tb_costo_items_codigo_key UNIQUE (codigo);


--
-- Name: tb_costo_items tb_costo_items_pkey; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_items
    ADD CONSTRAINT tb_costo_items_pkey PRIMARY KEY (id);


--
-- Name: tb_costo_mensual tb_costo_mensual_pkey; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_mensual
    ADD CONSTRAINT tb_costo_mensual_pkey PRIMARY KEY (id);


--
-- Name: tb_costo_mensual tb_costo_mensual_yyyymm_item_id_key; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_mensual
    ADD CONSTRAINT tb_costo_mensual_yyyymm_item_id_key UNIQUE (yyyymm, item_id);
...
--
-- Name: tb_narrativa_cache tb_narrativa_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_narrativa_cache
    ADD CONSTRAINT tb_narrativa_cache_pkey PRIMARY KEY (cache_key);


--
-- Name: tb_narrativa_log tb_narrativa_log_pkey; Type: CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_narrativa_log
    ADD CONSTRAINT tb_narrativa_log_pkey PRIMARY KEY (id);
...
--
-- Name: idx_costo_alias_item; Type: INDEX; Schema: public; Owner: stc_user
--

CREATE INDEX idx_costo_alias_item ON public.tb_costo_item_alias USING btree (item_id);


--
-- Name: idx_costo_mensual_mes; Type: INDEX; Schema: public; Owner: stc_user
--

CREATE INDEX idx_costo_mensual_mes ON public.tb_costo_mensual USING btree (yyyymm);
...
--
-- Name: idx_narrativa_cache_lotes; Type: INDEX; Schema: public; Owner: stc_user
--

CREATE INDEX idx_narrativa_cache_lotes ON public.tb_narrativa_cache USING btree (lotes, fecha);


--
-- Name: idx_narrativa_log_created; Type: INDEX; Schema: public; Owner: stc_user
--

CREATE INDEX idx_narrativa_log_created ON public.tb_narrativa_log USING btree (created_at DESC);
...
--
-- Name: idx_tb_narrativa_cache_key_origen; Type: INDEX; Schema: public; Owner: stc_user
--

CREATE INDEX idx_tb_narrativa_cache_key_origen ON public.tb_narrativa_cache USING btree (cache_key, origen);
...
--
-- Name: tb_costo_item_alias tb_costo_item_alias_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_item_alias
    ADD CONSTRAINT tb_costo_item_alias_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.tb_costo_items(id);


--
-- Name: tb_costo_mensual tb_costo_mensual_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: stc_user
--

ALTER TABLE ONLY public.tb_costo_mensual
    ADD CONSTRAINT tb_costo_mensual_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.tb_costo_items(id);
...
\unrestrict fWfKO3w8I26iGRh6KBjZYW6z6vasyMnHgbKPeW6aPJP0dUbmr8f5lYOLdaTWC9Z
